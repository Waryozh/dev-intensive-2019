...
class ProfileActivity : AppCompatActivity() {
    ...
    private fun initViews(savedInstanceState: Bundle?) {
        ...
        btn_edit.setOnClickListener {
            viewModel.afterRepositoryChanged(wr_repository.isErrorEnabled)
    ...
    private fun initViewModel() {
        ...
        viewModel.getIsRepositoryInvalid().observe(this, Observer { updateRepositoryError(it) })
        viewModel.getIsRepositoryErrorEnabled().observe(this, Observer { updateRepository(it) })
    }
